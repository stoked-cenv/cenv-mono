 ...
 */
  ...
  @Option({
    flags: '-cenv, --cenv',
    description: `Deploy cenv to aws account.`,
  })
  ...
  @Option({
    flags: '-v, --verify',
    description: `Verify the cenv installation on an environment.`,
  })
  ...
  @Option({
    flags: '-aka, --add-key-account <account>',
    description: 'Add an account to have access to the curb key',
  })
