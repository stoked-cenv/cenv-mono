import { RemovalPolicy, CfnOutput, Stack, StackProps, Fn } from 'aws-cdk-lib';
...
export class SpaStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const { APP, APP_DOMAIN, CDK_DEFAULT_REGION, ENV, CDK_DEFAULT_ACCOUNT, ROOT_DOMAIN, CENV_STACK_NAME, CENV_BUILD_PATH } = process.env;
    ...
    const bucket = new Bucket(this, `${ENV}-${CENV_STACK_NAME}`, {
      bucketName: `${ENV}-${CENV_STACK_NAME}`,
