...
export default class Fake {
  ...
  static randomOutput = [
    ...
    '-utility, dev-network, dev-root, dev-cenv-lib, dev-jslib, dev-site-certificate, dev-www-ui, dev-timestream, dev-core-middleware, dev-www-service, dev-live-data-se',
    ...
    'tificate\\\\n  - dev-www-service\\\\n    - dev-site-certificate\\\\n    - dev-network\\\\n  - dev-live-data-service\\\\n    - dev-network\\\\n    - dev-site-certificate\\\\n  - dev-hardware-configuration\\\\n    - dev-network\\\\n    - dev-site-certificate\\\\n-----------------------------------------------------------------------\\\\n-----------------------------------------------------------------------\\\\ndev-site-certificate complete\\\\n-----------------------------------------------------------------------\\\\nto-process 6 dev-www-ui, dev-timestream, dev-core-middleware, dev-www-servi',
