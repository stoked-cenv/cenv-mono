...
export const PageFooter = () => {
  const resourceList: Auth0Resource[] = [
    ...
    {
      path: "https://github.com/orgs/stoked-cenv/discussions",
        ...
        <div className="page-footer-grid__info">
          <div className="page-footer-info__message">
            <p className="page-footer-message__headline">
              <span> <b className="product"> cenv </b> by </span>
          ...
          <div className="page-footer-info__button">
            <a href="https://github.com/stoked-cenv/cenv-mono" className="btn btn-secondary d-inline-block">
              <svg className="svg-inline--fa fa-github fa-w-16" aria-hidden="true" data-prefix="fab" data-icon="github"
